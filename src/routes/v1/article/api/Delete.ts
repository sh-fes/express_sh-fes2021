...
import { articleModel as Article, Article_Schema_Options } from '../models';
...
const Delete: Delete_RequestHandler = (req, res, next) => {
    try {
        Article.findOne({ articleId: req.query.articleId }, {}, {}, (err, doc) => {
            ...
            doc.updateOne({ main: { display: null, seo: null, author: req.query.author }, $push: { archive: (doc as Article_Schema_Options).main } }, {}, (err, result) => {
                if (err) throw err;
